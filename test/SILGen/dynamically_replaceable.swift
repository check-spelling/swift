...
// CHECK-LABEL: sil hidden [dynamically_replaceable] [ossa] @$s23dynamically_replaceable6StructV1xACSi_tcfC : $@convention(method) (Int, @thin Struct.Type) -> Struct
// CHECK-LABEL: sil hidden [dynamically_replaceable] [ossa] @$s23dynamically_replaceable6StructV08dynamic_B0yyF : $@convention(method) (Struct) -> () {
// CHECK-LABEL: sil hidden [dynamically_replaceable] [ossa] @$s23dynamically_replaceable6StructV08dynamic_B4_varSivg
// CHECK-LABEL: sil hidden [dynamically_replaceable] [ossa] @$s23dynamically_replaceable6StructV08dynamic_B4_varSivs
// CHECK-LABEL: sil hidden [dynamically_replaceable] [ossa] @$s23dynamically_replaceable6StructVyS2icig : $@convention(method) (Int, Struct) -> Int
// CHECK-LABEL: sil hidden [dynamically_replaceable] [ossa] @$s23dynamically_replaceable6StructVyS2icis : $@convention(method) (Int, Int, @inout Struct) -> ()
// CHECK-LABEL: sil private [dynamically_replaceable] [ossa] @$s23dynamically_replaceable6StructV22property_with_observerSivW
// CHECK-LABEL: sil private [dynamically_replaceable] [ossa] @$s23dynamically_replaceable6StructV22property_with_observerSivw
struct Struct {
  dynamic init(x: Int) {
  }
